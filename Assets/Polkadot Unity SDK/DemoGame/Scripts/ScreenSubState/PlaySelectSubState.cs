...
namespace Assets.Scripts
{
    internal class PlaySelectSubState : GameBaseState
    {
        ...
        public override void EnterState()
        {
            ...
            TemplateContainer elementInstance = ElementInstance("DemoGame/UI/Elements/BottomSelectionElement");
        ...
        private void OnGridTileClicked(GameObject tileObject, int index)
        {
            ...
            FlowController.ChangeScreenSubState(DemoGameScreen.PlayScreen, DemoGameSubScreen.PlayTileUpgrade);
        }
        ...
        private void OnTileCardClicked(byte index)
        {
            ...
            FlowController.ChangeScreenSubState(DemoGameScreen.PlayScreen, DemoGameSubScreen.PlayTileSelect);
        }
    }
}