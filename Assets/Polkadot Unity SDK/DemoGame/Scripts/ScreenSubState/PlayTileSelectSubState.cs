...
{
    internal class PlayTileSelectSubState : GameBaseState
    {
            ...
            : base(flowController, parent)
        {
            ...
            _selectedMat = Resources.Load<Material>("DemoGame/Materials/emptySelected");
        }
        ...
        public override void EnterState()
        {
            ...
            TemplateContainer elementInstance = ElementInstance("DemoGame/UI/Elements/BottomTileSelectElement");
