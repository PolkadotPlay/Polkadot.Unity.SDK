...
{
    internal class PlayTargetSubState : GameBaseState
    {
        ...
        public PlayTargetSubState(DemoGameController flowController, GameBaseState parent)
        ...
        public override void EnterState()
        {
            ...
            TemplateContainer frameInstance = ElementInstance("DemoGame/UI/Frames/TargetFrame");
            ...
            TemplateContainer elementInstance = ElementInstance("DemoGame/UI/Elements/BottomWaitingElement");
