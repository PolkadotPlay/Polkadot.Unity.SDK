...
namespace Assets.Scripts.ScreenStates
{
    public class AccountSelectionState : WalletBaseScreen
    {
        ...
        public override void EnterState()
        {
            ...
            var visualTreeAsset = Resources.Load<VisualTreeAsset>("DemoWallet/UI/Screens/AccountsScreenUI");
            ...
            {
                var walletVisualTree = Resources.Load<VisualTreeAsset>("DemoWallet/UI/Elements/AccountFullElement");
